		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">
					拉拉 <small>租車小舖comid=${comId}測試用</small>
					numOfProducts=${prodsVos.size()}
				</h1>
			</div>
		</div>
		<!-- /.row -->
...
<!-- 			foreach也還是遵照Java index從0開始，因為Java物件從後端丟到這裡 -->
 			<c:forEach var="ProductVO" items="${prodsVos}" begin="0" end="${prodsVos.size()-1}">
				<!-- 車車1 -->
				<div class="col-md-4 text-center">
					<div class="thumbnail">
						<a href="" data-toggle="modal" data-target="#prod_detail"> <img
							class="img-responsive"
							src='${pageContext.servletContext.contextPath}/ComFirstPageImg?comID=${comId}'
							alt="">
							<div class="caption">
