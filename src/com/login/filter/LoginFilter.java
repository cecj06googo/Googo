...
public class LoginFilter implements Filter {
	...
	private boolean checkLogin(HttpServletRequest req) {
		HttpSession session = req.getSession();
		MemVO loginMemToken = (MemVO) session.getAttribute("LoginMemOK");
		CompanyVO loginComToken = (CompanyVO) session.getAttribute("LoginComOK");
		if (loginMemToken == null && loginComToken == null) {
			return false;
		} else {
			return true;
		}
