	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("update".equals(action)) { 
			...
			try {
				...
				java.sql.Date mem_bdate = null;
				try {
					java.util.Date date=new SimpleDateFormat("yyyy/MM/dd").parse(req.getParameter("mem_bdate").trim());
					mem_bdate = new java.sql.Date(date.getTime());
				} catch (IllegalArgumentException e) {
					mem_bdate=new java.sql.Date(System.currentTimeMillis());
					errorMsgs.add("�п�J���!");
				}
