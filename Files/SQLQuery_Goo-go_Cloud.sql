...
insert into [dbo].[Ord_item] values (12,61,1,N'租戚戚','0987654321','0234567890','gg@ya.123',N'{"custFields":[{"id":"custField_2_PreBox","type":"PreBox","label":"機車愜意配件","value":"300","valueDescription":"對講機全罩安全帽2頂"},{"id":"custField_2_textarea","type":"textarea","label":"特殊需求","value":"無","valueDescription":""}]}',null);
